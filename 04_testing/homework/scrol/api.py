...
from scrol import scoring
from scrol import store
...
class CharField(Field):
    def __init__(self, *args, **kwargs):
        ...
        self.error_msgs.update({"invalid_type": "Value type must be str"})
...
class ArgumentsField(Field):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.error_msgs.update({"invalid_type": "Value type must be dict"})
...
class EmailField(CharField):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.error_msgs.update({"invalid_value": "Value must contain @ symbol"})
